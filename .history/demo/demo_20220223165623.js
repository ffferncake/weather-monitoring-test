...
function initDemoMap(){
    ...
    const precipitation = L.tileLayer('https://{s}.tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=152118f99e361e7816ebd28eb775a6c6' , { 
        format: 'image/png',
        transparent: true,
    });
    const clouds = L.tileLayer('https://{s}.tile.openweathermap.org/map/clouds_new/{z}/{x}/{y}.png?appid=152118f99e361e7816ebd28eb775a6c6' , { 
        format: 'image/png',
        transparent: true,
    });

    const pressure = L.tileLayer('https://{s}.tile.openweathermap.org/map/pressure_new/{z}/{x}/{y}.png?appid=152118f99e361e7816ebd28eb775a6c6' , { 
        format: 'image/png',
        transparent: true,
    });
